...
jQuery.widget("ui.filemanager", {
    ...
    _create: function() {
        ...
        if (!cols) {
            cols = [{
                ...
                "bSortable": false,
                "aaSorting": ["asc"],
                "sClass": "ui-filemanager-column-type"
            },
            {
                "sWidth": "auto",
                "aaSorting": ["asc", "desc"],
                "sClass": "ui-filemanager-column-name"
            },
            {
                "sWidth": "200px",
                "sClass": "ui-filemanager-column-date"
            },
            {
                "sWidth": "100px",
                "aaSorting": ["asc", "desc"],
                "sType": "size",
                "sClass": "ui-filemanager-column-size"
            },
            {
                "sWidth": "30px",
                "bSortable": false,
                "sClass": "ui-filemanager-column-next"
            }];
        }
        ...
        this.buttonBar = jQuery("<div/>", {
            'class': 'ui-filemanager-buttonbar'
        }).buttonset();
        this.pathWidget = jQuery('<div/>', {
            'class': 'ui-filemanager-path-widget'
        });
        ...
        this.element.dataTable({
            ...
            "fnRowCallback": this.options.rowCallback ? this.options.rowCallback : function(nRow, aData, iDisplayIndex) {
                ...
                jQuery("td:eq(0)", nRow).html(jQuery("<span/>", {
                    'class': 'ui-icon ' + typeClass
                }));
                ...
                jQuery("td:eq(4)", nRow).hover(function() {
    ...
    setButtons: function(buttons) {
        ...
        jQuery.each(buttons, function(index, value) {
            ...
            }).data('is_disabled', value.disabled).button(value.disabled ? 'disable' : 'enable').click(function(e) {
                jQuery(this).blur()
            }).click(function() {
    ...
    disableButtons: function(disable) {
        if (typeof disable == 'undefined' || disable) {
            ...
            this.buttonBar.find("button").each(function() {
                $(this).button($(this).data("is_disabled") ? 'disable' : 'enable')
            });
        }
    },
    ...
    getSelected: function() {
        return jQuery(".ui-filemanager-state-selected", this.element).map(function() {
    ...
    _dirCallback: function(row, options) {
        ...
        function(json) {
            ...
            fake2.removeAttr('id').css({
                margin: 0
            }).addClass('ui-fake').hide();
