/*
    ...
    BridgeInterface.h - this file is part of bubba-networkmanager.
    ...
    $Id$
*/
#ifndef BRIDGEINTERFACE_H_
#define BRIDGEINTERFACE_H_

#include "Interface.h"

namespace NetworkManager {

class BridgeInterface: public NetworkManager::Interface {
protected:
...
public:
	BridgeInterface(const string& device);
